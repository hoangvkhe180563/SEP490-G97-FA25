...
import { Calendar as CalendarIcon, Camera, Lock } from "lucide-react";
                ...
                <li key={r.id} className="flex items-start gap-2">
                  <span
                    className={`w-4 h-4 rounded-full mt-1 ${
                      r.test(newPassword) ? "bg-emerald-500" : "bg-gray-300"
                    }`}
                  />
                  <span
                    className={`${
                      r.test(newPassword) ? "text-gray-700" : "text-gray-500"
                    }`}
                  >
                    {r.label}
                  </span>
