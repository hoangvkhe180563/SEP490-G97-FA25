              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center gap-4 text-gray-700 text-sm">
                  <span className="flex items-center gap-1">
                    <BookOpen className="fill-blue-500 stroke-blue-500" /> Môn <b>{course.subjectName}</b>
                  </span>
                  <span className="flex items-center gap-1">
                    <GraduationCap className="fill-orange-500 stroke-orange-500" /> Khối <b>{course.grade}</b>
                  </span>
                </div>
              </div>
            </div>
