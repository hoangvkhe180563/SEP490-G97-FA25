...
export const CommentSection: React.FC<CommentSectionProps> = ({
  ...
  const handleSaveEdit = async (commentId: number) => {
    ...
    editImages.forEach((img) => formData.append("attachments", img));
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          document
                            .getElementById(`edit-images-${comment.comment_id}`)
                            ?.click();
                        }}
                        onDoubleClick={(e) => e.stopPropagation()}
                      ...
                      >
                        ...
                        Ảnh ({editImages.length}/4)
                      </Button>
                      <input
                        id={`edit-images-${comment.comment_id}`}
                        type="file"
                        accept="image/*"
                        multiple
                        className="hidden"
                          ...
                          {isReplyEditing ? (
                            <div className="space-y-2">
                              ...
                              <div className="flex gap-2">
                                ...
                                <input
                                  id={`edit-images-${reply.comment_id}`}
                                  type="file"
                                  accept="image/*"
                                  multiple
                                  className="hidden"
                                ...
                                <Button
                                  ...
                                  onClick={(e) => {
                                    e.stopPropagation();
                                    handleSaveEdit(reply.comment_id);
                                  }}
                                  onDoubleClick={(e) => e.stopPropagation()}
                                  disabled={!editContent.trim()}
                                >
