...
public static class CourseMapper
{
    ...
    public static Course ToEntity(this CourseDto dto)
    {
        var course = new Course
        {
            ...
            Difficulty = Enum.TryParse<CourseDifficulty>(dto.Difficulty, true, out var _d) ? _d : CourseDifficulty.Beginner,
            Length = Enum.TryParse<CourseLength>(dto.Length, true, out var _l) ? _l : CourseLength.Short,
            Price = dto.Price,
            Grade = dto.Grade,
