    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
            ...
            entity.HasMany(d => d.Subjects).WithMany(p => p.Users)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.IndexerProperty<short>("SubjectId").HasColumnType("smallint(6)");
                    });
        });
        ...
        modelBuilder.Entity<Course>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("current_timestamp()")
                .HasColumnType("datetime");
            entity.Property(e => e.Difficulty).HasColumnType("tinyint(4)");
            entity.Property(e => e.EndAt).HasColumnType("datetime");
            entity.Property(e => e.Grade).HasColumnType("tinyint(4)");
            entity.Property(e => e.Information).HasMaxLength(1000);
            entity.Property(e => e.Length).HasColumnType("tinyint(4)");
            entity.Property(e => e.Name).HasMaxLength(200);
        ...
        modelBuilder.Entity<InteractiveQuestion>(entity =>
        {
            ...
            entity.Property(e => e.TimeSec)
                .HasComment("Thời điểm tính bằng giây trong video")
                .HasColumnType("int(11)");
            entity.Property(e => e.Type)
        ...
        modelBuilder.Entity<InteractiveResponse>(entity =>
        {
            ...
            entity.Property(e => e.SelectedIndex)
                .HasComment("Chỉ số lựa chọn nếu dạng MC")
                .HasColumnType("int(11)");
        ...
        modelBuilder.Entity<LlmHistory>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt)
                .HasDefaultValueSql("current_timestamp()")
                .HasColumnType("datetime");
            entity.Property(e => e.InputTokens).HasColumnType("int(11)");
            entity.Property(e => e.Llmresponse)
                .HasColumnType("json")
                .HasColumnName("LLMResponse");
            entity.Property(e => e.OutputTokens).HasColumnType("int(11)");
            entity.Property(e => e.Status)
        ...
        modelBuilder.Entity<Notification>(entity =>
        {
            ...
            entity.HasIndex(e => e.TargetGroupId, "TargetGroupId");

            entity.HasIndex(e => e.TargetRoleId, "TargetRoleId");

            entity.HasIndex(e => e.TargetUserId, "TargetUserId");

            entity.HasIndex(e => e.CreatedBy, "idx_notifications_createdby");

            entity.HasIndex(e => e.ExpiresAt, "idx_notifications_expires");

            entity.HasIndex(e => new { e.TargetType, e.TargetRoleId, e.TargetGroupId, e.TargetUserId }, "idx_notifications_target");
            ...
            entity.Property(e => e.TargetGroupId).HasColumnType("int(11)");
            entity.Property(e => e.TargetType)
                .HasDefaultValueSql("'All'")
                .HasColumnType("enum('All','Role','Group','User')");
            entity.Property(e => e.Title).HasMaxLength(500);

            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.NotificationCreatedByNavigations)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("notifications_ibfk_4");

            entity.HasOne(d => d.TargetGroup).WithMany(p => p.Notifications)
        ...
        modelBuilder.Entity<NotificationGroup>(entity =>
        {
            ...
            entity.HasIndex(e => e.CreatedBy, "idx_notification_groups_createdby");
            ...
            entity.HasOne(d => d.CreatedByNavigation).WithMany(p => p.NotificationGroups)
                .HasForeignKey(d => d.CreatedBy)
                .OnDelete(DeleteBehavior.SetNull)
                .HasConstraintName("notification_groups_ibfk_1");
        });
        ...
        modelBuilder.Entity<NotificationGroupMember>(entity =>
        {
            ...
            entity.ToTable("notification_group_members");

            entity.HasIndex(e => e.UserId, "idx_ngm_user");
            ...
            entity.HasOne(d => d.Group).WithMany(p => p.NotificationGroupMembers)
                .HasForeignKey(d => d.GroupId)
                .HasConstraintName("notification_group_members_ibfk_1");

            entity.HasOne(d => d.User).WithMany(p => p.NotificationGroupMembers)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("notification_group_members_ibfk_2");
        });
        ...
        modelBuilder.Entity<NotificationRead>(entity =>
        {
            ...
            entity.HasIndex(e => e.NotificationId, "idx_nr_notification");

            entity.HasIndex(e => new { e.UserId, e.IsRead, e.ReadAt }, "idx_nr_user");
            ...
            entity.HasOne(d => d.Notification).WithMany(p => p.NotificationReads)
                .HasForeignKey(d => d.NotificationId)
                .HasConstraintName("notification_reads_ibfk_1");

            entity.HasOne(d => d.User).WithMany(p => p.NotificationReads)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("notification_reads_ibfk_2");
        });
        ...
        modelBuilder.Entity<QAConversation>(entity =>
        {
            ...
            entity.Property(e => e.TopicId).HasColumnType("smallint(6)");
